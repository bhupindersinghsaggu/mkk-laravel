        ...
        <div class="flex flex-col sm:flex-row gap-4">
            ...
            <div class="flex-1">
                ...
                <div id="botton-container" class="mt-12 flex flex-col sm:flex-row gap-4  ">
                    ...
                    <button
                        class="px-8 py-3 font-semibold text-xl rounded-lg text-red-700  border border-white shadow-sm hover:bg-opacity-90">
            ...
            <div class="flex-1 hidden lg:flex justify-center items-center relative">
                ...
                <!-- Image -->
                <img src="./assets/images/hero.webp"alt="Students at MKK School"
                    class="relative z-10 object-cover rounded-full shadow-lg">
            </div>
        </div>
    </div>
</section>
